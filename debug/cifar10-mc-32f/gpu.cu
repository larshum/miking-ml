...
typedef struct Rec4 {float init_alpha; float init_lambda; float decay_alpha; float decay_lambda; int64_t batchsize; int64_t epochs; char printStatus; char evaluateBetweenEpochs; char evaluateBeforeFirstEpoch;} Rec4;
...
__host__ __device__ float t35(Tensor x3, Tensor w2, int64_t n4, int64_t x_offset1, int64_t j1, float acc4, int64_t i12) {
  int64_t t36;
  (t36 = (n4 * i12));
  int64_t t37;
  (t37 = (t36 + j1));
...
__host__ __device__ float t50(Tensor z4, int64_t offset1, float acc6, int64_t i16) {
  int64_t t51;
  (t51 = (offset1 + i16));
  float t52;
  (t52 = ((z4.data)[t51]));
...
__host__ __device__ float t65(Tensor p, Tensor dldp, int64_t s_offset, int64_t i20, float p_i, float acc8, int64_t j3) {
  char t66;
  (t66 = (j3 == i20));
  float s_ij;
  if ((t66 == 1)) {
...
__host__ __device__ void iterfun10(Tensor x7, float c2, Tensor z10, int64_t x_offset2, int64_t i26) {
  float t87;
  (t87 = ((z10.data)[i26]));
  int64_t t88;
  (t88 = (i26 + x_offset2));
...
__global__ void loopKernel12(int64_t n15, Tensor x7, float c2, Tensor z10, int64_t x_offset2) {
...
__host__ __device__ void iterfun11(Tensor x8, float c3, Tensor z11, int64_t z_offset, int64_t i27) {
  int64_t z_idx3;
  (z_idx3 = (i27 + z_offset));
  float t92;
  (t92 = ((z11.data)[z_idx3]));
...
__global__ void loopKernel13(int64_t n16, Tensor x8, float c3, Tensor z11, int64_t z_offset) {
...
__host__ __device__ void t99(Tensor z13, int64_t offset3, int64_t idx16, float v3, int64_t j4) {
  char t100;
  (t100 = (j4 == idx16));
  if ((t100 == 1)) {
    int64_t t101;
...
__host__ __device__ float t108(Tensor z14, int64_t m14, int64_t i31, float acc10, int64_t j5) {
  int64_t s_idx8;
  (s_idx8 = (j5 + 1));
  int64_t s_offset1;
...
__host__ __device__ int64_t t204(int64_t nnCompType_FullyConnected, float batchsize_regularizer, int64_t x11, Rec comp12) {
...
__host__ __device__ int64_t t206(int64_t nnCompType_FullyConnected, float lambda, int64_t x12, Rec comp13) {
  float t207;
  (t207 = (2. * lambda));
...
__host__ __device__ int64_t t209(int64_t nnCompType_FullyConnected, float alpha, int64_t x13, Rec comp14) {
  float t210;
  (t210 = (-alpha));
...
__host__ __device__ float nnAccuracyProportion(int64_t nnCompType_FullyConnected, int64_t nnCompType_ReLU, int64_t nnCompType_SoftMax, char printStatus2, Rec2 network5, Seq2 batches1) {
  ...
  float t264;
  (t264 = (( float ) correct_guesses1));
  float t265;
  (t265 = (( float ) datalength));
  {
    float t266;
    (t266 = (t264 / t265));
    return t266;
...
void cuda_wrap(int64_t nnCompType_FullyConnected, int64_t nnCompType_ReLU, int64_t nnCompType_SoftMax, int64_t nnLossfnType_CrossEntropyLoss, int64_t nnLossfnType_SoftMaxCrossEntropyLoss, Rec4 params, Rec2 network6, int64_t rounds, Seq2 training_batches, Seq2 validation_batches) {
  ...
  float t311;
  float X90 = (params.init_lambda);
  (t311 = X90);
  float t312;
  float X91 = (params.init_alpha);
  (t312 = X91);
  ((t302._0) = t312);
  ((t302._1) = t311);
  int64_t t313;
...
extern "C" void ve1FzN1WPvC(value nnCompType_FullyConnected, value nnCompType_ReLU, value nnCompType_SoftMax, value nnLossfnType_CrossEntropyLoss, value nnLossfnType_SoftMaxCrossEntropyLoss, value params, value network6, value rounds, value training_batches, value validation_batches) {
  ...
  Rec4 gpu_tmp5;
  float cuda_rec_field = Double_val(Field(params, 0));
  ((gpu_tmp5.init_alpha) = cuda_rec_field);
  float cuda_rec_field1 = Double_val(Field(params, 1));
...
extern "C" void vVse9MFEvHB(value (*args), int argc) {
  return ve1FzN1WPvC((args[0]), (args[1]), (args[2]), (args[3]), (args[4]), (args[5]), (args[6]), (args[7]), (args[8]), (args[9]));
}